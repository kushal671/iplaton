...
import { Grid, Box, Flex, Container, Heading, Button, jsx } from "theme-ui";
...
const Topbar: React.FC<{}> = () => {
  ...
  useOnClickOutside(mobileSearchRef, () => setMobileSearchToggle(false));
  ...
  return (
    <Fragment>
      <Box sx={styles.topbar}>
        ...
        {/* End of side drawer for mobile menu */}
      </Box>
    </Fragment>
  );
};
